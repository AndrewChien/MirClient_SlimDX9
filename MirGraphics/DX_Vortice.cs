...
namespace Client.MirGraphics
{
    public class DX_Vortice
    {
        ...
        public static void DX_InitRadarTexture()
        {
            ...
            using (Bitmap image = new Bitmap(2, 2, (int)stream.RowPitch, System.Drawing.Imaging.PixelFormat.Format32bppArgb, stream.DataPointer))
        ...
        public static void DX_InitPoisonDotBackgroundTexture()
        {
            ...
            using (Bitmap image = new Bitmap(5, 5, (int)stream.RowPitch, System.Drawing.Imaging.PixelFormat.Format32bppArgb, stream.DataPointer))
            using (Graphics graphics = Graphics.FromImage(image))
            {
                graphics.Clear(Color.White);
            }
        ...
        public static ID3D11Texture2D DX_InitLightTexture(int width, int height)
        {
            ...
            using (Bitmap image = new Bitmap(width, height, width * 4,
                System.Drawing.Imaging.PixelFormat.Format32bppArgb, DX_DataRectanglePointer(stream)))
            {
                using (Graphics graphics = Graphics.FromImage(image))
                {
        ...
        /// 画线
        /// </summary>
        public static void DX_LineDraw(Vector2[] points, Color4 color)
        {
