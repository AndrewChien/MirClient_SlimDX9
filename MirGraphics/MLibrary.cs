...
namespace Client.MirGraphics
{
    ...
    public sealed class MLibrary
    {
        ...
        public void Draw(int index, Point point, Size size, Color colour)
        {
            ...
            var matrix = DX_Slim.DX_MatrixScaling(scaleX, scaleY);
            DX_Slim.DX_SpriteTransform = matrix;
            ...
            DX_Slim.DX_SpriteTransform = DX_Slim.DX_MatrixIdentity();
    ...
    public sealed class MImage
    {
        ...
        public unsafe void CreateTexture(BinaryReader reader)
        {
            ...
            Image = DX_Slim.DX_NewTextureNoneManaged(w, h);
            var stream = DX_Slim.DX_TextureLockRectangle(Image);
            Data = (byte*)DX_Slim.DX_DataRectanglePointer(stream);

            DecompressImage(reader.ReadBytes(Length), stream.Data);

            stream.Data.Dispose();
            DX_Slim.DX_TextureUnlockRectangle(Image);
