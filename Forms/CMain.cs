    ...
    public partial class CMain : DX_RenderForm
    {
        ...
        private static void RenderEnvironment()
        {
            try
            {
                ...
                DX_Slim.DX_DeviceClearTarget00(Color.CornflowerBlue);
                DX_Slim.DX_DeviceBeginScene();
                DX_Slim.DX_SpriteBeginAlphaBlend();
                DXManager.SetSurface(DX_Slim.MainSurface);

                if (MirScene.ActiveScene != null)
                    MirScene.ActiveScene.Draw();

                DX_Slim.DX_SpriteEnd();
                DX_Slim.DX_DeviceEndScene();
                DX_Slim.DX_DevicePresent();
            }
            catch (DX_Slim.DX_Direct3D9Exception ex)
            {
        ...
        private static void ToggleFullScreen()
        {
            ...
            DX_Slim.DX_ParametersWindowed = !Settings.FullScreen;
        ...
        public void CreateScreenShot()
        {
            ...
            using (var stream = DX_Slim.DX_DeviceGetBackBuffer00Stream())
            {
        ...
        public static void SetResolution(int width, int height)
        {
            ...
            DX_Slim.DX_DeviceClearTarget00(Color.Black);
            DX_Slim.DX_DevicePresent();
            DXManager.ResetDevice();
