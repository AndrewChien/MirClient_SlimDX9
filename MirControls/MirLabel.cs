    ...
    public class MirLabel : MirControl
    {
        ...
        protected override unsafe void CreateTexture()
        {
            ...
            if (ControlTexture == null || ControlTexture.Disposed)
            {
                ...
                ControlTexture = DX_Slim.DX_NewTextureNoneManaged(Size.Width, Size.Height);
                TextureSize = Size;
            }

            var stream = DX_Slim.DX_TextureLockRectangle(ControlTexture);
            using (Bitmap image = new Bitmap(Size.Width, Size.Height, Size.Width * 4, PixelFormat.Format32bppArgb, DX_Slim.DX_DataRectanglePointer(stream)))
            {
            ...
            DX_Slim.DX_TextureUnlockRectangle(ControlTexture);
            DX_Slim.DX_Flush();
            TextureValid = true;
        }
